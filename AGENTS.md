...
A name card designer that generates 10 unique designs from user details, lets users purchase selected designs via Stripe, and stores purchased designs linked to their email in Supabase.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "249869994+superaih2025@users.noreply.github.com"
  git config user.name "superaih2025"
  ```
